...
class Emoji {
	...
	public static function emoji_to_html ( $text ) {
		...
		$text = self::emoji_unified_to_html( $text );
		return $text;
	}
	
	public static function html_to_emoji ( $text ) {
		$text = self::emoji_html_to_unified( $text );
		return $text;
	}
	
	private static function emoji_all_to_unified ( $text ) {
	...
	private static function emoji_unified_to_names ( $text )	{ return self::emoji_convert($text, 'names'); }
